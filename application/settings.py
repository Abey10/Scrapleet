...
SECRET_KEY = 'django-insecure-vu4ay_76t+6drg$q@7g!k)ob2pt@x3=spr!2!+tsexhiu&siy8'
...
# Use a separate directory for STATIC_ROOT
STATIC_ROOT = os.path.join(BASE_DIR, 'staticfiles')

# Specify the directories where Django should look for static files during development
STATICFILES_DIRS = [
...
JAZZMIN_SETTINGS = {
    ...
    'site_brand': "Application...",
    # 'site_logo': "assets/images/FINBb.png",
    'copyright':  "All Right Reserved 2024",
    "welcome_sign": "Welcome to Application, Login Now.",
    "topmenu_links": [
